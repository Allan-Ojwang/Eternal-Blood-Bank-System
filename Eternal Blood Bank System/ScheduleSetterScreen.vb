...
Public Class ScheduleSetterScreen
    ...
    Private Sub ScheduleSetterScreen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        GenerateDayPanel(37)
        DisplayCurrentDate()
    End Sub
    ...
    Private Sub AddNewAppointment(ByVal sender As Object, e As EventArgs)
        ...
        If day <> 0 Then
            EventSetterScreen.AppID = 0
            EventSetterScreen.LocationTb.Text = ""
            EventSetterScreen.ActivityTb.Text = ""
            EventSetterScreen.DR.Value = New Date(currentDate.Year, currentDate.Month, day)
            EventSetterScreen.ShowDialog()
            DisplayCurrentDate()
        End If
    End Sub
    ...
    Private Sub GenerateDayPanel(ByVal totalDays As Integer)
        ...
        For i As Integer = 1 To totalDays
            ...
            AddHandler f1.Click, AddressOf AddNewAppointment
