        ...
        Else
            ...
            Else
                Try
                    ...
                    sql = "Insert into Users (First_Name,Last_Name,Email,Phone_Number,Date_Of_Birth,Gender,Username,Pass) values('" & FirstNameTb.Text & "','" & LastNameTb.Text & "','" & EmailTb.Text & "'," & Val(NumberTb.Text) & ",'" & DOB.Value & "','" & GenderCb.Text & "','" & UsernameTb.Text & "','" & PasswordTb.Text & "')"
                    cmd.Connection = con
                    cmd.CommandText = sql
